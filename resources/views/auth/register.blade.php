...
<script>
    ...
    function validateForm() {
        ...
        if($("#agreecheck").is(":checked") && valid && $("#firstname").val().length != 0 && $("#lastname").val().length != 0 && $("#password").val().length != 0 && $("#address").val().length != 0&& $("#postcode").val().length != 0&& $("#city").val().length != 0 && $("#select-profession-submit").val().length != 0) {
            console.log("Yes");
