...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <form class="w-full bg-white px-4 md:px-8 py-6 md:py-10 mx-auto shadow-md maxwidth-508" method="post" action="{{ route('login') }}">
        @csrf
        <p class="text-4xl text-center pb-10 fontbold">Se connecter</p>
        <p class="text-xl pt-0 pb-3 fontbold">E-mail*</p>
        <input id="email" type="email" name="email" class="w-full p-4 focus:outline-none bg-input" placeholder="E-mail" required/>
        @error('email')
            <div class="py-3">
        ...
        <div class="input-group m-0 p-0">
            <input id="password" type="password" name="password" class="form-control bg-input" placeholder="Mot de passe" required/>
