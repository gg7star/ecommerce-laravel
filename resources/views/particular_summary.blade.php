        ...
        <div class="w-full lg:w-8/12 pr-0 lg:pr-5">
            ...
            <div id="transaction_finish" class="">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 mb-4 mx-auto maxwidth-820">
                    ...
                    <a href="/account_part_projects" class="py-4 mb-4 md:mb-0 md:mr-1 md:ml-1 shadow-md text-center bg-white text-lg fontbold cursor-pointer">Enregistrer mon projet</a>
