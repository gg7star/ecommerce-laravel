...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <form class="w-full bg-white px-4 md:px-15 py-4 md:py-10 mx-auto shadow-md maxwidth-976" action="/">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 col-gap-6 row-gap-20">
                ...
                <div class="flex pb-8 relative">
                    <div class="check-item mr-4 md:mr-9 active">
                        <label class="text-base flex items-center">
                            ...
                            <input type="radio" class="absolute left-0 opacity-0" id="male" name="gender" checked />
                            Monsieur
                        </label>
                    </div>
                    <div class="check-item mr-4 md:mr-9">
                        ...
                        <input type="radio" class="absolute left-0 opacity-0" id="female" name="gender" />
                        Madame</label>
                    </div>
                </div>
                <p class="text-xl pb-3 fontbold">Prénom*</p>
                <input id="firstname" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Prénom" required/>
                <p class="text-xl pb-3 fontbold">Nom*</p>
                <input id="lastname" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Nom" required/>
                <p class="text-xl pb-3 fontbold">E-mail*</p>
                <input id="email" type="text" class="w-full p-4 mb-6 bg-input" placeholder="E-mail" required/>
            ...
            <div class="">
                ...
                <input type="text" class="w-full p-4 mb-6 bg-input" placeholder="Nom de la société"/>
                <p class="text-xl pt-0 pb-3 fontbold">Adresse*</p>
                <input id="address" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Adresse" required/>
                <div class="w-full flex-none md:flex">
                    <div class="w-full md:w-5/12">
                        <p class="text-xl pt-0 pb-3 fontbold">Code Postal*</p>
                        <input id="postcode" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Code Postal" required/>
                    </div>
                    <div class="w-full md:w-7/12 md:pl-6 mb-6 md:mb-0">
                        <p class="text-xl pt-0 pb-3 fontbold">Ville*</p>
                        <input id="city" type="text pb-9" class="w-full p-4 bg-input" placeholder="Ville" required/>
                    </div>
                </div>
                <p class="text-xl pt-0 pb-3 fontbold">Numéro de téléphone</p>
                <input type="text" class="w-full p-4 bg-input" placeholder="Téléphone"/>
        ...
        <div class="w-full text-center md:text-left pt-8">
            <button class="px-15 py-4 text-white register-submit-button fontbold">S’inscrire</button> 
        </div>
