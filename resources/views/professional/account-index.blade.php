...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-20">
    ...
    <div class="w-full shadow-md bg-white pt-4 md:pt-10 px-4 md:px-15 pb-4 md:pb-15 mx-auto maxwidth-816">
        ...
        <a href="{{ route('pro-projects') }}" class="flex items-center border-t border-underline pt-6" style="padding-bottom:22px;">
        ...
        <a href="{{ route('pro-history') }}" class="flex items-center border-t border-underline pt-6" style="padding-bottom:22px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
        ...
        <a href="{{ route('pro-info') }}" class="flex items-center border-t border-underline pt-6" style="padding-bottom:22px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
