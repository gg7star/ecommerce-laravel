...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <div class="w-full shadow-md bg-white pt-4 md:pt-10 px-4 md:px-15 pb-4 md:pb-15 mx-auto maxwidth-816">
        <p class="text-4xl fontbold text-center pb-11 leading-normal">Mon compte professionnel</p>
        <a href="/account_pro_projects" class="flex items-center border-t border-underline">
        ...
        <a href="/account_pro_his" class="flex items-center border-t border-underline">
        ...
        <a href="/account_pro_info" class="flex items-center border-t border-underline">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
