...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-20">
    ...
    <div>
        <div class="flex-none md:flex items-center pt-35px pb-6">
            ...
            <span class="text-base text-dark fontbold">Mon compte professionnel</span>
        </div>
    </div>
    
    <div class="w-full shadow-md bg-white pt-4 md:pt-10 px-4 md:px-15 pb-4 md:pb-15 mx-auto maxwidth-816">
        <p class="text-4xl fontbold text-center pb-10 leading-normal">Mon compte professionnel</p>
        <a href="/account_pro_projects" class="flex items-center border-t border-underline" style="padding-top:25px; padding-bottom:25px;">
        ...
        <a href="/account_pro_his" class="flex items-center border-t border-underline" style="padding-top:25px; padding-bottom:25px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
        ...
        <a href="/account_pro_info" class="flex items-center border-t border-underline" style="padding-top:25px; padding-bottom:25px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
        ...
        <form class="w-full" method="post" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full flex items-center border-t border-underline" style="padding-top:25px; padding-bottom:25px;">
                <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
