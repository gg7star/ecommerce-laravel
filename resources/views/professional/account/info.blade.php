...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-562">
    ...
    <div>
        <div class="flex-none md:flex items-center pt-35px pb-6">
            ...
            <span class="text-base text-dark fontbold">Mes informations personnelles</span>
        </div>
    </div>
    ...
    <form class="w-full px-4 md:px-15 pt-4 pb-4 md:pt-50 md:pb-10 mb-4 shadow-md bg-white mx-auto maxwidth-1032" method="post" action="{{ route('modifyinfo_pro') }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 col-gap-6 row-gap-20">
            <div class="">
                ...
                <input id="firstname" name="firstname" type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Prénom" value="@if(isset($user["firstname"])){{$user["firstname"]}}@endif" required/>
                <p class="text-lg fontbold" style="padding-bottom:13px;">Nom*</p>
                <input id="lastname" name="lastname" type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Nom" value="@if(isset($user["lastname"])){{$user["lastname"]}}@endif" required/>
                <p class="text-lg fontbold" style="padding-bottom:13px;">E-mail*</p>
                <input id="email" name="email" type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="E-mail" value="@if(isset($user["email"])){{$user["email"]}}@endif" required/>
            ...
            <div class="">
                ...
                <div class="flex pb-9">
                    ...
                    <div class="check-item item-mode mr-9 @if(isset($user["mode"]) && $user["mode"] == 0) active @endif">
                        <label class="text-base flex items-center">
                            <div class="mr-4">
                                <svg class="checked" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
     	                        <g id="radio-button-on">
                ...
                <input type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Nom de la société" value="@if(isset($user["company"])){{$user["company"]}}@endif"/>
                <p class="text-lg fontbold" style="padding-bottom:13px;">Adresse*</p>
                <input id="address" name="address" type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Adresse" value="@if(isset($user["address"])){{$user["address"]}}@endif" required/>
                <div class="w-full flex-none md:flex">
                    <div class="w-full md:w-5/12">
                        <p class="text-lg fontbold" style="padding-bottom:13px;">Code Postal*</p>
                        <input id="postcode" name="postcode" type="text" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Code Postal" value="@if(isset($user["postcode"])){{$user["postcode"]}}@endif" required/>
                    </div>
                    <div class="w-full md:w-7/12 md:pl-6 mb-6 md:mb-0">
                        <p class="text-lg fontbold" style="padding-bottom:13px;">Ville*</p>
                        <input id="city" name="city" type="text pb-9" class="w-full px-4 mb-7 bg-input text-base h-input" style="padding-top:19px; padding-bottom:18px;" placeholder="Ville" value="@if(isset($user["city"])){{$user["city"]}}@endif" required/>
                    </div>
                </div>
