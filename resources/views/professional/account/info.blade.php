        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 col-gap-6 row-gap-20">
            <div class="">
                ...
                <div class="input-group">
                    <input id="password" name="password" type="password" class="form-control bg-input" placeholder="Mot de passe" value="@if(isset($user["password"])){{$user["password"]}}@endif" required/>
                ...
                <div class="flex pb-8">
                    <div class="check-item mr-4 md:mr-9 @if(isset($user["mode"]) && $user["mode"] == 1) active @endif">
                        <label class="text-base flex items-center">
                            ...
                            <input type="radio" class="absolute left-0 opacity-0" id="pro" name="mode" value="1" @if(isset($user["mode"]) && $user["mode"] == 1) checked @endif />
                            Professionnel
                        </label>
                    </div>
