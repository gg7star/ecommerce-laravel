...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <div class="w-full mx-auto maxwidth-676">
        ...
        <div class="bg-white shadow-md py-52 text-center" style="">
            ...
            <p class="text-lg pt-4 pb-2 px-1">Merci pour votre message, nous y répondrons dans les plus brefs délais.</p>
        </div>
    </div>
