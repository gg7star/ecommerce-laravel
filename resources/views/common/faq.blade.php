...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <div>
        <div class="flex-none md:flex items-center pt-35px pb-6">
            ...
            <span class="text-base text-dark fontbold">Foire au questions (FAQ)</span>
        </div>
    </div>
    
    <p class="text-4xl fontbold pt-4 md:pt-10 pb-8 md:pb-15">Foire aux questions (FAQ)</p>
            ...
            @foreach($faqs as $key => $item)
                <div class="w-full bg-white shadow-md">
                    <div class="w-full flex justify-between items-center cursor-pointer select-item" >
                        <p class="text-lg fontbold py-4 pl-6">{{$item["title"]}}</p>
