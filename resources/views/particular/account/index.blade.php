...
@section('title')
<title>{{__('Account|Particular')}}</title>
@endsection
...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-30">
    ...
    <div>
        <div class="flex-none md:flex items-center" style="padding-top:39px; padding-bottom:26px;">
            ...
            <span class="text-base fontbold">Mon compte particulier</span>
        </div>
    </div>
    
    <div class="w-full shadow-md bg-white pt-4 md:pt-50 px-4 md:px-15 pb-4 md:pb-15 mx-auto maxwidth-816">
        <p class="text-4xl fontbold text-center pb-11 leading-none">Mon compte particulier</p>
        <a href="/account_part_projects" class="flex items-center border-t border-underline" style="padding-top:28px; padding-bottom:23px;">
            ...
            <p class="text-lg fontbold pl-4 leading-none">Mes projets enregistrés</p>
        </a>
        <a href="/account_part_his" class="flex items-center border-t border-underline" style="padding-top:28px; padding-bottom:23px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
            ...
            <p class="text-lg fontbold pl-4 leading-none">Mon historique de commande</p>
        </a>
        <a href="/account_part_info" class="flex items-center border-t border-underline" style="padding-top:28px; padding-bottom:23px;">
            <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
            ...
            <p class="text-lg fontbold pl-4 leading-none">Mes informations personnelles</p>
        </a>
        <form class="w-full" method="post" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="w-full flex items-center border-t border-underline" style="padding-top:28px; padding-bottom:23px;">
                <svg class="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                ...
                <p class="text-lg fontbold pl-4 leading-none">Se déconnecter</p>
            </button>
        </form>
