...
<main id="main-content" class="bg-whitegreen px-8 pb-10 md:px-35 md:pb-562">
    ...
    <form class="w-full px-4 md:px-15 py-4 md:py-10 mb-4 shadow-md bg-white mx-auto maxwidth-1032" method="post" action="{{ route('modifyinfo_part') }}">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 col-gap-6 row-gap-20">
            <div class="">
                ...
                <input id="firstname" name="firstname" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Prénom" value="@if(isset($user["firstname"])){{$user["firstname"]}}@endif"/>
                <p class="text-xl pb-3 fontbold">Nom*</p>
                <input id="lastname" name="lastname" type="text pb-9" class="w-full p-4 mb-6 bg-input" placeholder="Nom" value="@if(isset($user["lastname"])){{$user["lastname"]}}@endif"/>
                <p class="text-xl pb-3 fontbold">E-mail*</p>
                <input id="email" name="email" type="text pb-9" class="w-full p-4 mb-6 bg-input" placeholder="E-mail" value="@if(isset($user["email"])){{$user["email"]}}@endif"/>
            ...
            <div class="">
                ...
                <div class="flex pb-8">
                    ...
                    <div class="check-item mr-4 md:mr-9 @if(isset($user["mode"]) && $user["mode"] == 0) active @endif">
                        <label  class="text-base flex items-center">
                            <div class="mr-4">
                                <svg class="checked" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
     	                        <g id="radio-button-on">
                ...
                <input type="text" id="company" name="company" class="w-full p-4 mb-6 bg-input" placeholder="Nom de la société" value="@if(isset($user["company"])){{$user["company"]}}@endif" disabled/>
                <p class="text-xl pb-3 fontbold">Adresse*</p>
                <input id="address" name="address" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Adresse" value="@if(isset($user["address"])){{$user["address"]}}@endif"/>
                <div class="w-full flex-none md:flex">
                    <div class="w-full md:w-5/12">
                        <p class="text-xl pt-0 pb-3 fontbold">Code Postal*</p>
                        <input id="postcode" name="postcode" type="text" class="w-full p-4 mb-6 bg-input" placeholder="Code Postal" value="@if(isset($user["postcode"])){{$user["postcode"]}}@endif"/>
                    </div>
                    <div class="w-full md:w-7/12 md:pl-6 mb-6 md:mb-0">
                        <p class="text-xl pt-0 pb-3 fontbold">Ville*</p>
                        <input id="city" name="city" type="text pb-9" class="w-full p-4 bg-input" placeholder="Ville" value="@if(isset($user["city"])){{$user["city"]}}@endif"/>
                    </div>
                </div>
